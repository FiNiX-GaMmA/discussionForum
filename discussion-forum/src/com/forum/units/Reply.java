...
public class Reply extends AbstractEntity {
	...
	public void setMessage(String message) {
		// please write your code here
		this.message = message;// You should set the instance variable message to the
	...
	public void setUser(User user) {
		// please write your code here
		this.user = user;// You should set the instance variable user to the user variable
	...
	public void setQuestion(Question question) {
		// please write your code here
		this.question = question;// You should set the instance variable question to the question variable
		// that is passed into this method
	}
}
