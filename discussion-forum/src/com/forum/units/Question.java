...
public class Question extends AbstractEntity {
	...
	public void setTitle(String title) {
		// please write your code here
		this.title = title;// Set the instance variable title to the parameter variable title
	}
	...
	public void setMessage(String message) {
		// please write your code here
		this.message = message;// you should set the instance variable message to the parameter variable message
	}
	...
	public void setUser(User user) {
		// please write your code here
		this.user = user;// You should set the instance variable user to the parameter variable user
	}
	...
	public void increaseUpvoteCount() {
		...
		upvoteCount++;// Increase the number stored in the instance variable upvoteCount by 1
	}
